      ...
      <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '3rem 1rem' }}>
        ...
        >
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            {error && (
              <div style={{ padding: '0.75rem', borderRadius: '10px', backgroundColor: '#FEE2E2', color: '#DC2626', fontSize: '0.82rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <AlertCircle size={16} />
                <span>{error}</span>
              </div>
            )}
            ...
            {success && (
              <div style={{ padding: '0.75rem', borderRadius: '10px', backgroundColor: 'var(--brand-emerald-light)', color: 'var(--brand-emerald)', fontSize: '0.82rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
            ...
            <button
              ...
              style={{ width: '100%', justifyContent: 'center', marginTop: '0.5rem', backgroundColor: 'var(--brand-emerald)', fontWeight: 800 }}
            >
          ...
          >
            ...
            <div style={{ marginTop: '2px' }}>Email: <code style={{ color: 'var(--brand-blue)', fontWeight: 700 }}>sudhir@gmail.com</code></div>
            <div>Password: <code style={{ color: 'var(--brand-blue)', fontWeight: 700 }}>1234567890</code></div>
          </div>
        </div>
      </main>
